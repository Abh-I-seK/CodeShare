...
export default function CodeSpace(props : {code : string}){
    ...
    return(
        ...
        <div className="text-center mb-3">
            ...
            {/* <Button>Copy <Copy className='w-4 ml-1'/></Button> */}
        
        </div>
        <CodeMirror height="500px" value={props.code} theme={materialDark}></CodeMirror>
        {/* <textarea className='w-full h-full'>{props.code}</textarea> */}
        </div>  
    )
